...
<html>
                ...
                <div class="container-fluid">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <p style="font-size:12px; color:#888; margin:3px 0 0 30px;">Alicorp S.A.A. &mdash; Movimientos de Almac&eacute;n</p>
                        </div>
                        <a href="InsertarNotadeIngreso.jsp" style="background:#C8102E;color:#fff;border:none;border-radius:8px;padding:11px 22px;font-size:13.5px;font-weight:500;text-decoration:none;display:inline-flex;align-items:center;gap:6px;">
                            <i class="fas fa-plus"></i> Registrar Nueva Nota de Ingreso
                        </a>
                    </div>
                </div>
            </section>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card" style="border-radius:12px; overflow:hidden; border:none; box-shadow:0 2px 12px rgba(0,0,0,.07);">
                                <div class="card-header" style="background:#fff; border-bottom:1px solid #f0f0f0;">
                                    <h3 class="card-title" style="color:#1a1f2e; font-size:14px; font-weight:600;"><i class="fas fa-filter" style="color:#C8102E;margin-right:6px;"></i>Filtros de b&uacute;squeda</h3>
                                ...
                                <div class="card-body"> 
                                    <p style="font-size:12px; color:#888; margin:-6px 0 14px;">
                                        ...
                                        Filtra por <b>Proveedor</b> (qui&eacute;n entreg&oacute; el producto), por <b>N&uacute;mero de documento</b> del proveedor,
                                        por el <b>N&uacute;mero de la nota</b> ya emitida, o por un <b>rango de fechas</b>. Puedes combinar varios filtros a la vez.
                                    </p>
                                    <div class="row">
                                    ...
                                    <div class="full-width panel-content" id="div1">
                                        <table id="B" class="table table-striped table-bordered second" style="width:100%">
                                            ...
                                            <td>
                                                <%
                                                    if (Estado.equalsIgnoreCase("Pendiente")) {%>
                                                <a class="btn-success btn-sm" style="margin-right:4px;" onclick="completarNI(<%= vent.getIdmovimiento()%>)"><i class="fas fa-check-circle"></i> Completar</a>
    ...
    <script>
        ...
        function completarNI(id) {
            if (!confirm("\u00bfConfirmar que la mercader\u00eda ya lleg\u00f3 al almac\u00e9n? Esto sumar\u00e1 el stock de cada producto.")) return;
            $.post("NotadeIngresoController", {accion: "Completar", txtid: id}, function (res) {
                if (res.trim() === "ok") {
                    toastr.success("Nota de Ingreso completada: el stock ya se actualiz\u00f3");
                    setTimeout(function () { location.reload(); }, 800);
                } else {
                    toastr.error("No se pudo completar la nota");
                }
            });
        }
    </script>
