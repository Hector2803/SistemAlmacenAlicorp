                ...
                <div class="container-fluid">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <p style="font-size:12px; color:#888; margin:3px 0 0 30px;">Alicorp S.A.A. &mdash; Despacho y Transporte</p>
                        </div>
                        <a href="InsertarGuiaremisioncliente.jsp" style="background:#C8102E;color:#fff;border:none;border-radius:8px;padding:11px 22px;font-size:13.5px;font-weight:500;text-decoration:none;display:inline-flex;align-items:center;gap:6px;">
                            <i class="fas fa-plus"></i> Registrar Nueva Gu&iacute;a de Remisi&oacute;n
                        </a>
                    </div>
                </div>
            </section>
                            ...
                            <div class="card" style="border-radius:12px; overflow:hidden; border:none; box-shadow:0 2px 12px rgba(0,0,0,.07);">
                                ...
                                <div class="card-body"> 
                                    <p style="font-size:12px; color:#888; margin:-6px 0 14px;">
                                        ...
                                        Filtra por <b>Cliente</b> (destino de la guía), por su <b>N&uacute;mero de documento</b>,
                                        por el <b>N&uacute;mero de gu&iacute;a</b> ya emitida, o por un <b>rango de fechas</b>. Puedes combinar varios filtros a la vez.
                                    </p>
                                    <div class="row">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <%
                                                        ...
                                                        String newdd = da; // si no se reconoce el formato, se muestra tal cual
                                                        try {
                                                            if (da != null && da.length() >= 10) {
                                                                String soloFecha = da.substring(0, 10);
                                                                if (soloFecha.charAt(4) == '-') {
                                                                    // formato guardado como yyyy-MM-dd (o yyyy-M-d sin ceros, dato antiguo)
                                                                    ...
                                                                    // formato guardado como dd/MM/yyyy
                                                                    newdd = soloFecha;
                                                                }
                                                            }
                                                        } catch (Exception ex) {
