...
<html lang="es">
    <head>
        ...
        <title>Unidad de Medida | Alicorp</title>
    ...
    <body class="hold-transition sidebar-mini">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <h3 style="font-size:20px; font-weight:600; color:#1a1f2e; margin:0;">
                                <i class="fas fa-balance-scale" style="color:#C8102E; margin-right:10px;"></i>
                        ...
                        <a href="#addUnidadmedida" class="btn-nuevo-alicorp" data-toggle="modal">
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center"><i class="fas fa-list" style="color:#C8102E; margin-right:8px;"></i><h3 class="card-title mb-0">Lista de Unidades de Medida</h3></div>
        ...
        <!-- Modal Agregar -->
        <div id="addUnidadmedida" class="modal fade modal-alicorp">
            <div class="modal-dialog" role="document" style="z-index:9999; width:450px;">
                <div class="modal-content">
                    <form id="newuv" action="UnidadmedidaController" method="Post" name="frm_nuevo">
                        <div class="modal-header">
                            <h4 class="modal-title"><i class="fas fa-plus-circle"></i> Agregar Unidad de Medida</h4>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label>Nombre</label>
                                <input type="text" name="txtNom" class="form-control" placeholder="Ej: Kilogramo, Caja, Unidad">
                            </div>
            ...
            <div class="modal-dialog" role="document" style="z-index:9999; width:450px;">
                <div class="modal-content">
                    <form id="edituv" method="post" action="UnidadmedidaController" name="frm_edit">
                        <div class="modal-header">
                            <h4 class="modal-title"><i class="fas fa-pencil-alt"></i> Editar Unidad de Medida</h4>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
                        <div class="modal-body">
