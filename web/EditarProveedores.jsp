...
<html lang="es">
    <head>
        ...
        <title>Editar Proveedor | Alicorp</title>
                ...
                <div class="container-fluid">
                    <form id="editproveedor" action="ProveedorController" method="Post" name="frm_edit">
                            ...
                            <div class="col-md-6">
                                <div class="form-card">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="Txtnumerodocumento" onkeypress="return soloNumeros(event)" value="<%= cl.getNumerodocumento()%>" maxlength="11" id="cedula" class="form-ali" required>
                                        <span id="respuesta"></span>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Direcci&oacute;n</label>
                                        <input type="text" name="Txtdireccion" value="<%= cl.getDireccion()%>" id="Txtdireccion" class="form-ali" required>
                                    </div>
                                    <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-card">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="Txtfechaderegistro" value="<%=cl.getFechaderegistro()%>" class="form-ali">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="Txttelefono" value="<%=cl.getTelefono()%>" onkeypress="return soloNumeros(event)" class="form-ali">
                                    </div>
                                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-between" style="margin-top:4px;">
                            ...
                            <button onclick="return validareditproveedores()" type="submit" name="accion" class="btn" style="background:#C8102E;color:#fff;border:none;border-radius:8px;padding:11px 28px;font-size:13.5px;font-weight:500;">
