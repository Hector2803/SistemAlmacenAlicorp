...
<html>
    <head>
        ...
        <title>Stock Mínimo | Alicorp</title>
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <h3 style="font-size:20px; font-weight:600; color:#1a1f2e; margin:0;">
                        <i class="fas fa-arrow-down" style="color:#C8102E; margin-right:10px;"></i>
                        Stock Mínimo
                    </h3>
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <%  ProductoDAO pddaoPreview = new ProductoDAO();
                                    boolean sinAlertas = pddaoPreview.ListadoStockminimo().isEmpty();
                                    if (sinAlertas) { %>
                                <div style="background:#e8f5e9; border:1px solid #a9e0bb; color:#1e7a3d; padding:12px 16px; border-radius:8px; font-size:13px; margin-bottom:16px;">
                                    <i class="fas fa-check-circle"></i> Ning&uacute;n producto est&aacute; actualmente por debajo de su stock m&iacute;nimo configurado. Todo el inventario est&aacute; en niveles saludables.
                                </div>
                                <% } %>
