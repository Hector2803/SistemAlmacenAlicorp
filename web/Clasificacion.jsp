...
<html lang="es">
    <head>
        ...
        <title>Clasificaci&oacute;n | Alicorp</title>
    ...
    <body class="hold-transition sidebar-mini">
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center"><i class="fas fa-list" style="color:#C8102E; margin-right:8px;"></i><h3 class="card-title mb-0">Lista de Clasificaciones</h3></div>
        ...
        <!-- Modal Agregar -->
        <div id="addClasificacion" class="modal fade modal-alicorp">
                ...
                <div class="modal-content">
                    <form id="newclasi" action="ControllerClasificacion" method="Post" enctype="multipart/form-data" name="frm_nuevo">
                        <div class="modal-header">
                            <h4 class="modal-title"><i class="fas fa-plus-circle"></i> Agregar Clasificaci&oacute;n</h4>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label>Nombre</label>
                                <input type="text" name="txtNom" class="form-control" placeholder="Ej: Consumo Masivo">
                            </div>
                        </div>
            ...
            <div class="modal-dialog" role="document" style="z-index:9999; width:450px;">
                <div class="modal-content">
                    <form id="editclasi" method="post" action="ControllerClasificacion" name="frm_edit">
                        <div class="modal-header">
                            <h4 class="modal-title"><i class="fas fa-pencil-alt"></i> Editar Clasificaci&oacute;n</h4>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
                        <div class="modal-body">
