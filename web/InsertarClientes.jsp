...
<html lang="es">
    <head>
        ...
        <title>Nuevo Cliente | Alicorp</title>
    ...
    <body class="hold-transition sidebar-mini">
            ...
            <section class="content-header" style="padding:18px 24px 10px;">
                <div class="container-fluid">
                    <h3 style="font-size:20px; font-weight:600; color:#1a1f2e; margin:0;">
                        <i class="fas fa-user-plus" style="color:#C8102E; margin-right:10px;"></i>
                ...
                <div class="container-fluid">
                    <form id="newcliente" action="ClienteController" method="Post" name="frm_nuevo">
                            ...
                            <div class="col-md-6">
                                <div class="form-card">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="Txtapellidos" class="form-ali" placeholder="Nombre completo o raz&oacute;n social" required>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="Txtnumerodocumento" onkeypress="return soloNumeros(event)" maxlength="11" id="input_ruc" class="form-ali" placeholder="DNI / RUC" required>
                                        <span id="resultado"></span><span id="existente"></span>
                                        <div id="respuesta"></div>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Direcci&oacute;n</label>
                                        <input type="text" name="Txtdireccion" id="Txtdireccion" class="form-ali" placeholder="Direcci&oacute;n del cliente">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Correo</label>
                                        <input type="email" name="Txtcorreo" id="Txtcorreo" class="form-ali" placeholder="correo@ejemplo.com">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-card">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="Txtcontacto" class="form-ali" placeholder="Persona de contacto">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="genero-opt">
                                            <label><input type="radio" name="Txtsexo" value="M"> Masculino</label>
                                            <label><input type="radio" name="Txtsexo" value="F"> Femenino</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="d-flex justify-content-between" style="margin-top:4px;">
                            ...
                            <button onclick="return validarnewcliente()" type="submit" name="accion" class="btn" style="background:#C8102E;color:#fff;border:none;border-radius:8px;padding:11px 28px;font-size:13.5px;font-weight:500;">
        ...
        <script>
            $(document).ready(function () {
                $("#input_ruc").on("keyup", function () {
                    var cedula = $("#input_ruc").val();
                    $.ajax({
