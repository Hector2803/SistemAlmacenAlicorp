...
<html lang="es">
    <head>
        ...
        <style>
            ...
            .modal-alicorp select.form-control { -webkit-appearance:none; }
            ...
            .badge-tipo { display:inline-block; font-size:11px; font-weight:600; padding:3px 10px; border-radius:20px; }
            .badge-ingreso { background:#e8f5e9; color:#2e7d32; }
            .badge-salida { background:#fce4e4; color:#c62828; }
        </style>
    </head>
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center"><i class="fas fa-list" style="color:#C8102E; margin-right:8px;"></i><h3 class="card-title mb-0">Lista de Motivos</h3></div>
                ...
                <div class="modal-content">
                    <form id="newcategoria" action="MotivoController" method="Post" name="frm_nuevo">
                        <div class="modal-header">
                            <h4 class="modal-title"><i class="fas fa-plus-circle"></i> Agregar Motivo</h4>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label>Nombre</label>
                                <input type="text" name="txtNom" class="form-control" placeholder="Ej: Devolucion, Merma">
                            </div>
                            <div class="form-group">
                                <label>Tipo</label>
            ...
            <div class="modal-dialog" role="document" style="z-index:9999; width:450px;">
                <div class="modal-content">
                    <form id="editcategoria" method="post" action="MotivoController" name="frm_edit">
                        <div class="modal-header">
                            <h4 class="modal-title"><i class="fas fa-pencil-alt"></i> Editar Motivo</h4>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
                        <div class="modal-body">
