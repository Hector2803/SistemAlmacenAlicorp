...
<html>
    <head>
        ...
        <title>Registro de Salida | Alicorp</title>
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <h3 style="font-size:20px; font-weight:600; color:#1a1f2e; margin:0;">
                        <i class="fas fa-file-export" style="color:#C8102E; margin-right:10px;"></i>
                        Registro de Salida
                    </h3>
                    <p style="font-size:12px; color:#888; margin:3px 0 0 30px;">Alicorp S.A.A. &mdash; Reporte de Notas de Salida</p>
                </div>
            </section>
        ...
        $(document).ready(function () {
            var table = $('#B').DataTable({
                ...
                buttons: [
                    ...
                    {extend: 'excelHtml5', text: 'Exportar Excel', footer: true, title: 'Registro de Salida - Alicorp'},
                    {extend: 'pdfHtml5', text: 'Exportar PDF', footer: true, title: 'Registro de Salida - Alicorp'},
                    {
                        extend: 'print',
                        ...
                        customize: function (win) {
                            $(win.document.body)
                                ...
                                .prepend(
                                    ...
                                    '<p style="margin:2px 0 0;font-size:12px;">Registro de Salida &mdash; Sistema SIGA v1.0</p>' +
                                    '</div>' +
